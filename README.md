...
- Run "npm install"
- Run "npm run start" for development version
- Run "npm run bs" for production version
- The columns that can be sorted are named "Yds", "TD" and "Lng" and are coloured blue. Click on a column to use it to sort the rows (click again to reverse the sort order).
- Filter the rows by typing in all or part of a player's name
- Download the CSV file representing the table as it is currently shown by clicking the "Download table as CSV" button.
